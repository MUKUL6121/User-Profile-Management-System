...
var corsoptions = {
    origin: ['http://localhost:5173', 'https://1brmbrxl-5173.inc1.devtunnels.ms/'],
...
const client = new MongoClient('mongodb+srv://mannu_123:ioweurioejfklsdf@cluster0.5nrdhjn.mongodb.net/')
